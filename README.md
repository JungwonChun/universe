...
선착순 수업 신청(대기열 자동 승급) · 행사 캘린더 · 참여 랭킹 · 교류전/같이 치기 모집 게시판을 갖춘
...
git branch -M main
git remote add origin https://github.com/내아이디/universe.git
...
3. **[전체] 탭**에서 관리자 설정:
   - **수업 타임 추가** (예: 월 18:00–19:00 정원 6명, 월 19:00–20:00, 화 2타임...)
   - **자동 오픈 스케줄** (예: 일요일 21:00 → 매주 그 시각에 다음 주 신청이 자동 오픈)
...
| 오픈/마감 | 자동 스케줄 + [신청] 탭에서 관리자 수동 오픈/마감 가능 |
| 모집 게시판 | 글마다 "우리 단체만 / 전체 공개" 선택, 전체 공개 글엔 다른 동아리도 참여 가능 |
